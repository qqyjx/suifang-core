...
# screen.html = 患者自助填报页(公开入口, 患者扫码打开)。刻意做得很薄:
# 只按 token 取表单结构 + 提交, 从不请求任何患者数据接口。
PROTOTYPE_FILES=(platform.html platform-v2.html screen.html platform-demo.html platform-preview.html data-dashboard.html pulse-dashboard.html iwown-dashboard.html patient-demo.html index.html)
