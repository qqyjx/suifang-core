/* 杰理OTA流程库 version 2.1.0 , Gitee: https://gitee.com/Jieli-Tech/WeChat-Mini-Program-OTA, Github: https://github.com/Jieli-Tech/WeChat-Mini-Program-OTA*/
interface Logger {
...
declare function setTagEnable(tag: string, enable: boolean): void;
...
export { DeviceUpgradeInfo, FileOffset, IOTAOp, OTAConfig, OTAError, OTAImpl, OnResultCallback, OnUpgradeCallback, ReConnectMsg, UpgradeType, getErrorDesc, logd, loge, logi, logv, logw, setLogGrade, setLogger, setTagEnable };
/* follow me on Github! */
